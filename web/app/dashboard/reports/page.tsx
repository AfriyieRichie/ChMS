    ...
    <div className="p-6 space-y-8">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        {[
          ...
          { label: `Giving (${summary ? MONTH_NAMES[(summary.finance.month ?? 1) - 1] : "—"})`, value: summary ? `GHS ${Number(summary.finance.this_month).toLocaleString("en-GH", { minimumFractionDigits: 2 })}` : "—" },
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-5 shadow-sm">
        <h2 className="text-base font-semibold text-gray-800 mb-4">Attendance — Last 12 Weeks</h2>
        {attRecords.length === 0 ? (
      ...
      {/* Monthly giving */}
      <div className="bg-white rounded-xl border border-gray-200 p-5 shadow-sm">
        <h2 className="text-base font-semibold text-gray-800 mb-4">Monthly Giving — Last 6 Months</h2>
      ...
      {/* Giving by fund */}
      <div className="bg-white rounded-xl border border-gray-200 p-5 shadow-sm">
        <h2 className="text-base font-semibold text-gray-800 mb-4">Giving by Fund (All Time)</h2>
        {!fundSummary || fundSummary.by_fund.length === 0 ? (
          ...
          <>
            <table className="min-w-full">
              <thead>
                <tr>
                  <th className="text-left text-xs font-medium text-gray-400 uppercase pb-2">Fund</th>
                  <th className="text-right text-xs font-medium text-gray-400 uppercase pb-2">Contributions</th>
              ...
              <tfoot>
                <tr className="border-t border-gray-200">
                  <td className="pt-2 text-sm font-semibold text-gray-700">Grand Total</td>
                  <td />
